...
public class Runtime {
	...
	public static native void initInternal (String lang, String[] runtimeApks, String runtimeDataDir, String[] appDirs, ClassLoader loader, String[] assemblies, int apiLevel, boolean embeddedDSOsEnabled, boolean isEmulator);
